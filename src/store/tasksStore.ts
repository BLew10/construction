...
type CreateTaskPayload = Omit<Task, "id" | "criticalPath"> & { projectId: string };
...
export const useTasksStore = create<TasksStore>((set, get) => ({
	...
	fetchTasks: async (projectId: string) => {
		...
		try {
			console.log(`Fetching tasks for project: ${projectId}... (Not Implemented)`);
